...
| Dato | Valor | Fuente | Fecha de consulta |
|---|---|---|---|
| Licencia | Propietaria y comercial. Se contrata por suscripción SaaS bajo el **Oracle Cloud Services Agreement (CSA)**, el contrato estándar de Oracle para sus servicios cloud; no hay licencia perpetua ni acceso al código fuente | [Oracle Cloud Services Contracts - Oracle](https://oracle.com/contracts/cloud-services) · [Oracle Fusion Cloud ERP - Oracle](https://www.oracle.com/erp/) | 25/09/2026 |; no hay licencia perpetua ni acceso al código fuente | [Oracle Fusion Cloud ERP - Oracle](https://www.oracle.com/erp/) | 25/09/2026 |
...
| Dato | Valor | Fuente | Fecha de consulta |
|---|---|---|---|
| Licencia | Propietaria y comercial. Se contrata por suscripción SaaS por usuario y edición bajo el **Salesforce Main Services Agreement (MSA)**, versión vigente del 01/06/2026; no hay acceso al código fuente | [Agreements and Terms - Salesforce](https://www.salesforce.com/company/legal/agreements/) · [Previous Agreements - Salesforce](https://www.salesforce.com/company/legal/agreement-archive/) | 25/09/2026 | no hay acceso al código fuente | [Salesforce Releases - Salesforce](https://www.salesforce.com/products/innovation/releases/) | 25/09/2026 |
